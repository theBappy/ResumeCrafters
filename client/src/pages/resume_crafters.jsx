...
import PersonalInfoForm from "../components/form-content/personal-info-form";
  ...
  return (
    <div>
      <div className="max-w-7xl mx-auto px-4 py-6">
        <Link
          to={`/app`}
          className="inline-flex gap-2 items-center text-slate-500 hover:text-slate-700 transform-all"
        >
        ...
        <div className="grid lg:grid-cols-12 gap-8">
          ...
          <div className="relative lg:col-span-5 rounded-lg overflow-hidden">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1">
              ...
              <hr className="border-gray-200 absolute top-0 left-0 right-0 border-2" />
              <hr
          ...
          <div className="lg:col-span-7 max-lg:mt-6">
            <div className="">{/* buttons for different purpose */}</div>
