...
const DashboardPage = () => {
  ...
  const loadAllResumes = async () => {
    try {
      const { data } = await apiAxiosInstance.get("/api/users/resumes", {
  ...
  return (
    <div className="">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        {/* existing resume that has been created */}
        ...
        {showCreateResume && (
          ...
          >
            <div
              className="relative bg-slate-50 border shadow-md rounded-lg w-ful max-w-sm p-6"
              onClick={(e) => e.stopPropagation()}
            >
