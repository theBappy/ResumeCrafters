    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-gray-500">
          Add your technical & soft skills
        </p>
      </div>
      <div className="flex gap-2">
        <input
          type="text"
          placeholder="Enter a skill (e.g., JavaScript, Python, Project Management, Marketing, Design)"
          ...
          {data.map((skill, index) => (
            ...
            >
              ...
              <button
                ...
                className="ml-1 hover:bg-blue-200 rounded-full p0/5 transition-colors"
              >
